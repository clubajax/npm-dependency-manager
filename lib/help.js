...
deps:
    ...
    save options:
    -r or -repo:	folder name of the repo to save
    -m or -message	git commit message
    -v or -version	type of version update:
    	M:	major update (1.1.1 to 2.1.1)
    	m: minor update (1.1.1 to 1.2.1)
