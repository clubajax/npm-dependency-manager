...
deps:
    ...
    save options:
    -r	folder name of the repo to save (required)
    -m	git commit message (optional)
    -v	type of version update: (optional, defaults to "patch")
    	M | "major":	major update (1.1.1 to 2.0.0)
    	m | "minor": minor update (1.1.1 to 1.2.0)
    	p | "patch": patch update  (1.1.1 to 1.1.2) default
    	semantic string: the version to use (3.4.5)
`;
